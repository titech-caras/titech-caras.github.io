...
特に、これらの向上を実現するため、アプリケーションやシステムソフトウェアの特性・振る舞いの理解に基づいたハードウェア／ソフトウェア技術の研究に力を入れています。

**一緒に研究する仲間を募集しています！
まだまだ手探りですが [こんな研究室](message) にしていきたいと思っています。
計算機アーキテクチャをはじめとするコンピュータシステムの基盤技術やコンピュータセキュリティに興味がある方はぜひ佐々木に連絡を（[メール](mailto:sasaki@ict.eng.isct.ac.jp) や [X（旧Twitter）](https://twitter.com/hrshssk) などで）してください。**

**東京科学大情報通信系にあるコンピュータシステム関連の研究室を紹介した [文章](https://hiroshi-sasaki.github.io/blog/2020/12/22/introduction-to-systems-labs-in-titech-ict.html) を書いてみました（2020 年 12 月時点）。興味のある方は読んでみてください。**
